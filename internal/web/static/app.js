...
function renderSnapshot(snap) {
  ...
  document.getElementById("pressure").textContent = snap.boiler.steam_pressure_psi.toFixed(0);
  document.getElementById("mw").textContent = snap.boiler.output_mw.toFixed(1);
  document.getElementById("drum-level").textContent = snap.drum.level_percent.toFixed(1);
  document.getElementById("burner").textContent = snap.combustion.burner_phase;
  document.getElementById("o2").textContent = snap.combustion.excess_o2_pct.toFixed(2);
  trendData.push(snap.boiler.steam_pressure_psi);
...
document.getElementById("btn-purge").addEventListener("click", () => postAction("/purge/start?holder=hmi"));
document.getElementById("btn-purge-done").addEventListener("click", () => postAction("/purge/complete?holder=hmi"));
